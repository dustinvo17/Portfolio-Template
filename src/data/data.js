...
export const PROJECTS_DATA = [
    ...
    new ProjectData(
        ...
        ['UI development using HTML/CSS/SASS/Liquid.', 'Utilized VueJS, Ajax and Shopify API to achieve functionality of single page application in cart/product page for improving user experience'],
...
export const LINKS = {
    RESUME: 'https://drive.google.com/file/d/1bgd-RcN0eYLBnG4hvr3kD2-CYSvHS3JG/view?usp=sharing',
